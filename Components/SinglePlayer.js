        ...
        <ImageBackground style={{
          ...
          height: '100%',
            ...
            <View style={{
                ...
                <Text style={{marginLeft:70,fontSize:20,marginBottom:20}}>Select Difficulty Level</Text>
              <SegmentedControls
                options={options}
            ...
            <View style={{alignContent:'flex-end'}}>
                <TouchableOpacity style={styles.button1} onPress={() => navigation.navigate('GameScreen', {level:value})}>
          <Text
            style={{
              fontSize: 20,
            }}>
